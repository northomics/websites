   ...
   var t, n, a = {
      ...
      animate: function (t, n) {
         ...
         i.each(t, function () {
            ...
            }), l >= o && c <= s ? (i(this).css("visibility", "visible"), i(this).addClass(t), i(this).addClass("gm_animation_time")) : n.once === !1 && (i(this).css("visibility", "hidden"), i(this).removeClass(t), i(this).removeClass("gm_animation_time"))
         })
      }
   };
